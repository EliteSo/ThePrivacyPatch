namespace Facebook.Web.Tests.FacebookWebUtils.VerifyGetSubscription
{
    ...
    public class GivenARequestWithHubModeNotEqualToSubscribeThen
    {
        [Fact]
        ...
        private static HttpRequestBase GetRequest()
        {
            ...
            requestMock.Setup(request => request.Params).Returns(new NameValueCollection { { "hub.mode", "wrong_hub_mode" } });
