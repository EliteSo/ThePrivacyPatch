namespace Facebook.Web.Tests.FacebookWebUtils.VerifyPostSubscription
{
    ...
    public class GivenARequestWithHttpXHubSignatureWithoutStartFromSha1EqualsSignThen
    {
        [Fact]
        ...
        private static HttpRequestBase GetRequest()
        {
            ...
            requestMock.Setup(request => request.Params).Returns(new NameValueCollection { { "HTTP_X_HUB_SIGNATURE", "invalid signature starting without 'sha1='" } });
